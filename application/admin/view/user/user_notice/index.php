    ...
    <div class="layui-row layui-col-space15"  id="app">
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">常见问题列表</div>
                <div class="layui-card-body">
                    <div class="layui-btn-container">
                        <button class="layui-btn layui-btn-sm" onclick="$eb.createModalFrame(this.innerText,'{:Url('create')}')">添加常见问题</button>
                    </div>
...
<script>
    layList.tableList('List',"{:Url('index')}",function (){
        return [
            ...
            {field: 'title', title: '常见问题标题'},
            {field: 'content', title: '常见问题内容'},
